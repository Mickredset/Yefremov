...
define gui.about = _p("""История про Лобаново продолжается! Узнайте правду и пройдите игру на одну из нескольких концовок
""")
...
define config.save_directory = "Yefremov-1784793142"
